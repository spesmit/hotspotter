...
describe('repo', function () {
	describe('#createTree()', function() {
		...
		it('should create file tree with one path when given an array with one file paths', function (done) {
			...
			repoService.createTree([{FullPath:'/tempProjects/hashsha1/dir1/dir2/file1', Score: 0.5, Commits: [{Author: 'Bob', Time: 'Mon Dec 14 2015 03:35:33 GMT-0600 (CST)'}]}], function (err, res) {
		...
		it('should create file tree with many path when given an array with many file paths', function (done) {
			...
			repoService.createTree([
				{FullPath:'/tempProjects/hashsha1/dir1/dir2/file1', Score: 0.5, Commits: [{Author: 'Bob', Time: 'Mon Dec 14 2015 03:35:33 GMT-0600 (CST)'}]},
				{FullPath:'/tempProjects/hashsha1/dir1/file2', Score: 0.75, Commits: [{Author: 'Dave', Time: 'Mon Dec 14 2015 03:35:33 GMT-0600 (CST)'}]},
				{FullPath:'/tempProjects/hashsha1/dir1/dir2/dir3/file3', Score: 0.25, Commits: [{Author: 'Jane', Time: 'Mon Dec 14 2015 03:35:33 GMT-0600 (CST)'}]}
									], function (err, res) {
